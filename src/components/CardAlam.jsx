...
import image1 from "../assets/img/Alam/1.png";
import image2 from "../assets/img/Alam/2.png";
import image3 from "../assets/img/Alam/3.png";
import image4 from "../assets/img/Alam/4.png";
import image5 from "../assets/img/Alam/5.png";

// Dummy data untuk card
const cardData = [
  {
    id: 1,
    title: "Desa Wae Rebo, Flores",
          ...
          {cardData.map((card, index) => (
            ...
            >
              <div className="bg-white shadow-md rounded-md">
                ...
                <div className="p-4">
                  <h3 className="text-md font-bold text-dark mb-2">
                    {card.title}
                  </h3>
